 ...
 * ---------------------------------------------------------------------------
 * @author  generator
 * @date 2017/3/22 14:03
 * ---------------------------------------------------------------------------
 */
public class CommTools {

    /** 版本 */
    public static String MYBATIS_VERSION = "Mybatis3";
    /** 驱动 */
    public static String MYBATIS_DRIVER = "com.mysql.jdbc.Driver";
    /** NULL */
    public static String MYBATIS_NULL = "NULL";
    public static String MYBATIS_STRING = "String";
    public static String MYBATIS_BOOLEAN = "Boolean";
