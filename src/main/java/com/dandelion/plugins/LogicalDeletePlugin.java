...
import com.dandelion.plugins.utils.XmlElementGeneratorTools;
...
public class LogicalDeletePlugin extends PluginAdapter {
    ...
    /** 逻辑删除列-Key */
    public static final String LOGICAL_DELETE_COLUMN_KEY = "logicalDeleteColumn";
    /** 逻辑删除列-Key */
    public static final String LOGICAL_DELETE_VALUE_KEY = "logicalDeleteValue";
    /** 逻辑删除标志位常量名称 */
    public static final String DEL_FLAG_NAME = "DEL_FLAG";
    /** 逻辑删除查询方法 */
    public static final String METHOD_LOGICAL_DELETE = "andDeleted";
    /** 逻辑删除列 */
        ...
        for (IntrospectedColumn column : columns) {
            if (column.getActualColumnName().equalsIgnoreCase(logicalDeleteColumn)){
                ...
                if (JDBCType.BIGINT == type
                    ...
                    log.warn("itfsw(逻辑删除插件):"+introspectedTable.getFullyQualifiedTable()+"逻辑删除列("+introspectedTable.getTableConfigurationProperty(LOGICAL_DELETE_COLUMN_KEY)+")的类型不在支持范围（请使用数字列，字符串列，布尔列）！");
                }
            }
        }

        if (introspectedTable.getTableConfigurationProperty(LOGICAL_DELETE_COLUMN_KEY) != null && this.logicalDeleteColumn == null){
            log.warn("itfsw(逻辑删除插件):"+introspectedTable.getFullyQualifiedTable()+"没有找到您配置的逻辑删除列("+introspectedTable.getTableConfigurationProperty(LOGICAL_DELETE_COLUMN_KEY)+")！");
        }
    }
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        if (this.logicalDeleteColumn != null){
            ...
            log.debug("itfsw(逻辑删除插件):"+interfaze.getType().getShortName()+"增加方法logicalDeleteByExample。");
            ...
            if (introspectedTable.hasPrimaryKeyColumns()){
                ...
                log.debug("itfsw(逻辑删除插件):"+interfaze.getType().getShortName()+"增加方法logicalDeleteByPrimaryKey。");
            }
        }
        return true;
    }
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        if (this.logicalDeleteColumn != null){
            ...
            if (this.logicalDeleteValue == null || CommTools.MYBATIS_NULL.equalsIgnoreCase(this.logicalDeleteValue)){
                sb.append("NULL");
            ...
            log.debug("itfsw(逻辑删除插件):"+introspectedTable.getMyBatis3XmlMapperFileName()+"增加方法logicalDeleteByExample的实现。");
            ...
            if (introspectedTable.hasPrimaryKeyColumns()){
                ...
                log.debug("itfsw(逻辑删除插件):"+introspectedTable.getMyBatis3XmlMapperFileName()+"增加方法logicalDeleteByPrimaryKey的实现。");
            }
        }
        return true;
    }
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        if (this.logicalDeleteColumn != null){
            ...
            } else if (CommTools.MYBATIS_STRING.equalsIgnoreCase(this.logicalDeleteColumn.getFullyQualifiedJavaType().getShortNameWithoutTypeArguments())){
                field.setInitializationString("\"" + this.logicalDeleteValue + "\"");
            } else if (CommTools.MYBATIS_BOOLEAN.equalsIgnoreCase(this.logicalDeleteColumn.getFullyQualifiedJavaType().getShortNameWithoutTypeArguments())){
                field.setInitializationString(("1".equals(this.logicalDeleteValue) || "true".equalsIgnoreCase(this.logicalDeleteValue)) ? "true" : "false");
            } else {
                field.setInitializationString(this.logicalDeleteValue);
            }
            ...
            fields.add(0, field);
            log.debug("itfsw(逻辑删除插件):"+topLevelClass.getType().getShortName()+"增加方法DEL_FLAG的常量。");
        }
        return true;
    }
        ...
        if (this.logicalDeleteColumn != null){
            ...
            for (InnerClass innerClass : innerClasses) {
                if ("Criteria".equals(innerClass.getType().getShortName())) {
                    ...
                    log.debug("itfsw(逻辑删除插件):"+topLevelClass.getType().getShortName()+"."+innerClass.getType().getShortName()+"增加andDeleted方法。");
                }
            }
        }
        return true;
